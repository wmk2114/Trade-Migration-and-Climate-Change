...
```{r}
mc_1<- c("l1_xconst", "l1aclpn", "l1lnpop", "l1gdp_pc", "newtar", "date", "ctylabel")

mdf_1<- na.omit(merged_data[mc_1])
mdf_1$l1aclpn<- as.factor(mdf_1$l1aclpn)

mm1_1<- prais::prais_winsten(newtar~l1_xconst*l1aclpn+l1lnpop+l1gdp_pc+date+as.factor(ctylabel), data=mdf_3, index=c("date", "ctylabel"))
